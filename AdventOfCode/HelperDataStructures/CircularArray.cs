...
public class CircularArray<T> : IEnumerable<T>
{
    ...
    /// <summary>
    ///     Access an element based on it's index. Negative and positive indexes are allowed and will simply wrap around the
    ...
    ///     By default, will infinitely return items (as the array is "circular"). Set "infinite" to false to only iterate over
    ///     each element once.
    ...
    ///     By default, will infinitely return items (as the array is "circular"). Set "infinite" to false to aonly iterate
    ///     over each element once.
    ///     The iteration begins at the current item.
    /// </summary>
