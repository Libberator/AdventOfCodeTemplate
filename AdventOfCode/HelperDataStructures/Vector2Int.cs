...
public struct Vector2Int(int x, int y) : IEquatable<Vector2Int>, IFormattable
{
    ...
    public static readonly Vector2Int N = new(-1, 0);

    /// <summary>Gets the vector (0,1).</summary>
    public static readonly Vector2Int E = new(0, 1);

    /// <summary>Gets the vector (1,0).</summary>
    public static readonly Vector2Int S = new(1, 0);

    /// <summary>Gets the vector (0,-1).</summary>
    public static readonly Vector2Int W = new(0, -1);
    ...
    public readonly double DistanceEuclideanTo(Vector2Int other) => Math.Sqrt(DistanceSquaredTo(other));
    ...
    /// <summary>
    ///     Returns a value that indicates if this vector and <paramref name="other" /> are parallel and neither are
    ///     Vector2Int.Zero
    /// </summary>
    ...
    public readonly bool IsPerpendicularTo(Vector2Int other) =>
        this != Zero && other != Zero && X * other.X == -Y * other.Y;
    ...
    public static Vector2Int Clamp(Vector2Int value, Vector2Int min, Vector2Int max) =>
        Clamp(value, min.X, max.X, min.Y, max.Y);
    ...
    public static double DistanceEuclidean(Vector2Int a, Vector2Int b) => Math.Sqrt(DistanceSquared(a, b));
