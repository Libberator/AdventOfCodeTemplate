...
public struct Vector2Int : IEquatable<Vector2Int>, IFormattable
{
    ...
    public readonly double DistanceEuclidianTo(Vector2Int other)
    {
    ...
    ///     get from a to b.
    /// </summary>
    public readonly int DistanceChebyshevTo(Vector2Int other)
    {
    ...
    public readonly int DistanceManhattanTo(Vector2Int other)
    {
        return Math.Abs(other.X - X) + Math.Abs(other.Y - Y);
    }

    /// <summary>Returns the Euclidean distance squared between two specified points.</summary>
    public readonly int DistanceSquaredTo(Vector2Int other)
    {
        return (other.X - X) * (other.X - X) + (other.Y - Y) * (other.Y - Y);
    }

    /// <summary>Divides this vector by <paramref name="x" /> and <paramref name="y" /> using integer division.</summary>
    public void DivideBy(int x, int y)
    {
        X /= x;
        Y /= y;
    }
    ...
    public readonly bool IsDiagonalTo(Vector2Int other)
    {
    ...
    public readonly bool IsLateralTo(Vector2Int other)
    {
        return X == other.X ^ Y == other.Y;
    }

    /// <summary>
    ///     Returns a value that indicates if this vector and <paramref name="other" /> are parralel and neither are
    ///     Vector2Int.Zero
    /// </summary>
    public readonly bool IsParallelTo(Vector2Int other)
    {
        return this != Zero && other != Zero && X * other.Y == Y * other.X;
    }

    /// <summary>
    ///     Returns a value that indicates if this vector and <paramref name="other" /> are perpendicular and neither is
    ///     Vector2Int.Zero
    /// </summary>
    public readonly bool IsPerpendicularTo(Vector2Int other)
    {
        return this != Zero && other != Zero && X * other.X == -Y * other.Y;
    }
    ...
    public void MultiplyBy(Vector2Int scalars)
    {
        X *= scalars.X;
        Y *= scalars.Y;
    }
    ...
    {
        return Clamp(value, min.X, max.X, min.Y, max.Y);
    }

    /// <summary>Restricts a vector between a minimum and a maximum value.</summary>
    public static Vector2Int Clamp(Vector2Int value, int minX, int maxX, int minY, int maxY)
    {
        return new Vector2Int(Math.Clamp(value.X, minX, maxX), Math.Clamp(value.Y, minY, maxY));
    }

    /// <summary>Computes the Euclidian distance between the two given points.</summary>
    public static double DistanceEuclidian(Vector2Int a, Vector2Int b)
    {
    ...
    ///     get from a to b.
    /// </summary>
    public static int DistanceChebyshev(Vector2Int a, Vector2Int b)
    {
    ...
    public static Vector2Int Map(Vector2Int fromMin, Vector2Int fromMax, Vector2Int toMin, Vector2Int toMax,
        Vector2Int value)
    {
    ...
    public static Vector2Int RotateRight(Vector2Int value)
    {
    ...
    public static Vector2Int RotateLeft(Vector2Int value)
    {
        return new Vector2Int(-value.Y, value.X);
    }
    ...
    {
        return new Vector2Int(left * right.X, left * right.Y);
    }
    ...
    public static Vector2Int operator /(Vector2Int value, int divisor)
    {
        return new Vector2Int(value.X / divisor, value.Y / divisor);
    }
