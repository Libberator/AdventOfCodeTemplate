...
public interface INode
{
    ...
    /// <summary>
    ///     Cost to go to this node. Make sure the magnitude of this lines up with the scale of the HCost (a.k.a.
    ...
    ///     Make sure this and the BaseCost have the same magnitude. e.g. BaseCost of 10 for 10*Euclidian, BaseCost of 1 for
    ///     Manhattan/Chebyshev, etc.
    /// </summary>
    int GetHCostTo(INode target);
}

/// <summary>
///     Generic class to represent a point on a grid, and store extra info in Value. Used for A* Pathfinding and
///     Floodfill.
/// </summary>
