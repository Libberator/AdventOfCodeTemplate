...
public static partial class Utils
{
    ...
    {
        return Array.ConvertAll(data, long.Parse);
    }

    public static ulong[] ToULongArray(this string[] data)
    {
        return Array.ConvertAll(data, ulong.Parse);
    }

    public static BigInteger[] ToBigIntArray(this string[] data)
    {
        return Array.ConvertAll(data, BigInteger.Parse);
    }
    ...
    public static long BinaryToLong(this string s)
    {
    ...
    {
        return new StringBuilder(n * source.Length).Insert(0, source, n).ToString();
    }
