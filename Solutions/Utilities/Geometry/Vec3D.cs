...
public readonly record struct Vec3D(int X, int Y, int Z) : ISpanParsable<Vec3D>, ISpanFormattable
{
    ...
    public double DistanceEuclidean(Vec3D other) => DistanceEuclidean(this, other);

    /// <summary>
    ///     Computes the Chebyshev distance, also known as chessboard distance - the amount of moves a king would take to
    ///     get from a to b.
    /// </summary>
    public int DistanceChebyshev(Vec3D other) => DistanceChebyshev(this, other);

    /// <summary>
    ///     Computes the Manhattan distance (a.k.a. Taxicab distance) between this and an <paramref name="other" /> vector. No
    ///     diagonal moves.
    /// </summary>
    public int DistanceManhattan(Vec3D other) => DistanceManhattan(this, other);

    /// <summary>Returns the Euclidean distance squared between two specified points.</summary>
    public int DistanceSquared(Vec3D other) => DistanceSquared(this, other);
    ...
    public static double DistanceEuclidean(Vec3D a, Vec3D b) => Math.Sqrt(DistanceSquared(a, b));

    /// <summary>
    ///     Computes the Chebyshev distance, also known as chessboard distance - the amount of moves a king would take to
    ///     get from a to b.
    /// </summary>
    public static int DistanceChebyshev(Vec3D a, Vec3D b) =>
    ...
    public static int DistanceManhattan(Vec3D a, Vec3D b) =>
    ...
    public static int DistanceSquared(Vec3D a, Vec3D b) =>
    ...
    public static Vec3D Parse(string s) => Parse(s, null);

    public static Vec3D Parse(string s, IFormatProvider? provider) => Parse(s, NumberStyles.Integer, provider);
